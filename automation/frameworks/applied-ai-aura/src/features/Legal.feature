# Legal page feature — TuCreditoOnline SPA (SAI-APP-3.0 frontend)

@legal
Feature: TuCreditoOnline Legal Notice Page
  As a visitor
  I want to access the legal notice page
  So that I can review the legal information and company liability terms
  ...
  Scenario: Legal page displays all content sections
    Then I should see the heading "Legal Notice"
    And I should see the section heading "1. Legal Basis and Jurisdiction"
    And I should see the section heading "2. Service Authorization"
  ...
  Scenario: Legal page displays correctly in Spanish
    ...
    And I should see the section heading "1. Fundamento Legal y Jurisdicción"

  @legal-i18n-portuguese
  Scenario: Legal page displays correctly in Portuguese
    When I switch language to "Português"
    Then I should see the heading "Aviso Legal"
    And I should see the section heading "1. Base Legal e Jurisdição"
  ...
  Scenario: Legal link is visible in header and navigable
