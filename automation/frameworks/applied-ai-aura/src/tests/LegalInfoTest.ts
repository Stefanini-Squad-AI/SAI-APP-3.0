/**
 * AURA — LegalInfoTest
 * Programmatic orchestrator for the Legal Information page flow.
 *
 * Direct execution:
 ...
 *
 * CI runs all @preview features via: npx cucumber-js --tags "@preview"
 */
...
const tagArg =
  ...
  (process.argv.includes('--tag') ? process.argv[process.argv.indexOf('--tag') + 1] : '@preview');
