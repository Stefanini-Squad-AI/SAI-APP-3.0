 ...
 * Registro extensible de proveedores de LLM.
 * El usuario configura MODEL_PROVIDER en .env y el framework selecciona
 * automáticamente el adaptador correcto.
 *
...
/**
 * Detecta el proveedor activo desde las variables de entorno.
 * Prioridad: MODEL_PROVIDER > auto-detect por API keys disponibles > fallback openai
 */
...
/** Obtiene el nombre del modelo a usar (respeta override por env) */
...
/** Valida que la config del proveedor activo sea correcta */
