 ...
 * Motor de inferencia semántica propietario.
 * Ahora soporta múltiples proveedores LLM configurables por .env.
 *
 * Architecture:
 *   DOMExtractor     → snapshot compacto del DOM
 *   LLMAdapterFactory → selecciona el proveedor LLM activo (openai/gemini/perplexity/anthropic/ollama)
 *   SemanticCache    → evita llamadas redundantes a la API
 */
