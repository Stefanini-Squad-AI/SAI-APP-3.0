  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <aside
        ...
        } bg-primary-800 text-white transition-all duration-300 ease-in-out flex flex-col`}
      >
        ...
        <div className="p-4 border-t border-primary-700">
          ...
          {sidebarOpen && (
            <button
              ...
              className="mt-3 w-full flex items-center justify-center px-4 py-2 bg-red-600 hover:bg-red-700 rounded-lg transition text-sm font-medium"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
