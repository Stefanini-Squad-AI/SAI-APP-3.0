  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Reports & Statistics</h2>
        <p className="text-gray-600 mb-4">Generate detailed reports and export system data.</p>
